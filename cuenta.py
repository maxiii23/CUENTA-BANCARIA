...
abel = CuentaBancaria("abelito",)
masi = CuentaBancaria("masito23",)

masi.deposito(1000).deposito(2000).deposito(2000).retiro(500).generar_interes()
abel.deposito(1000).deposito(2000).retiro(100).retiro(400).retiro(300).retiro(200).generar_interes().mostrar_info_cuenta()

abel.mostrar_todas_las_instancias()
masi.mostrar_todas_las_instancias()
